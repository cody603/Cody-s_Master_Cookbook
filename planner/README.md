...
**Built 2026-09-14 15:12 UTC, on top of commit `4307637`.** *(A chat session compares this against the top of `CHANGELOG.md` — if a changelog row is newer than this stamp, the planner hasn't caught up with it yet. See `CHAT.md` §8.)*
