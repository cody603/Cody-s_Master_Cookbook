<!-- GENERATED from codys-cookbook.md#1-codys-pho — do not edit here; edit the master file and rerun tools/build_planner.py -->
...
> 🍱 **Batch the chuck — Cody, 2026-09-09:** *"Sometimes when I sous vide a beef I'll do two or three chuck roasts and reuse it when I make pho."* The three roasts in the ingredient list are already a batch; the point is that the sous vide beef keeps and comes back as a second pho night, which is why the [Meal Planning Sheet](../meal-planning-sheet.md) carries a *Pho with Leftover Beef* line pointed at [§7.146](7146-pho-with-leftover-brisket-and-smoked-bone-broth.md). *(That line sat in the sheet's 🍱 Leftovers group until 2026-09-12; the group is retired and the line now sits in 🍜 Pasta, Rice & Noodle Bowls — see [CLAUDE.md §3f](../../CLAUDE.md).)* [§T46](t46-freezing-and-reheating-leftovers.md) covers holding and reheating vacuum-bagged meat.
>
> 🧊 **And the other half of that habit, Cody, 2026-09-12: the extra roasts go in the freezer, so the second pho night starts with a thaw.** *"I'll cook an extra, or sous vide an extra chuck roast so I can get it all out of the way, and then I'll freeze both of those chuck roasts. If I do that, then I have to thaw the chuck roast as well for the pho."* **Plan the thaw as a real stage, the same way the 36-hour bath is a stage** — the countdown line above already reads backward from dinner, and a frozen roast simply adds one more offset in front of it. **Allow 2 days in the refrigerator for a whole chuck roast**, and start it earlier if two or three are thawing together. That figure is **USDA FSIS's** — its refrigerator guidance puts whole roasts at *2 days or longer*, and its rate of *at least a day for every 5 pounds* agrees for the 3-to-5-pound roasts here; the reading is the cookbook's, per [CLAUDE.md §3d](../../CLAUDE.md), and **his own figure supersedes it the day he gives one.** Thawing early costs nothing — FSIS keeps thawed beef roasts 3 to 5 days in the fridge. **[CLAUDE.md §3f](../../CLAUDE.md) is the standing rule**: ask whether the meat is frozen if he hasn't said, and put a thaw event on the calendar when it is. His reason for wanting it is plain — *"not thawing the meat is a thing that we do. We forget to thaw the meat sometimes."*

**Techniques used:** [T2 Hot Pan First, Then Oil](t2-hot-pan-first-then-oil.md)
