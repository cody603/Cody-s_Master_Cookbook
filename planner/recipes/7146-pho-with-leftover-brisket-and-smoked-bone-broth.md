<!-- GENERATED from codys-cookbook.md#7146-pho-with-leftover-brisket-and-smoked-bone-broth — do not edit here; edit the master file and rerun tools/build_planner.py -->
...
> ✅ **2026-09-07 re-verified once more against the clean reshoot of p. 218** (steps 1–10 read at native resolution): every step, figure, and the three garnish sentences match. No change. *(The page's bottom third is the title box and opening headnote of The Ultimate Prime Rib Roast, tracked in [§12](12-recipes-to-document.md) — its recipe starts on p. 219, which is still unphotographed.)*

> **This cookbook's second pho, and the two are genuinely different dishes.** [§1 Cody's Pho](1-codys-pho.md) is the house recipe — chuck roast, a long simmered beef broth, and Cody's own charred-aromatic method, and the reference case for this cookbook's whole difficulty philosophy. **This one starts with leftovers**: a brisket you already smoked, and bones you smoke before they ever hit the pot. Both kept, cross-referenced. See also [§8.37 Chicken and Garlic Soup](837-chicken-and-garlic-soup.md)'s *Pho Gà* variation, a chicken version from a third source, and [§7.104 Smoked Bone Broth](7104-smoked-bone-broth.md), the earlier Meathead book's own smoked broth — a close cousin of the broth half of this recipe, kept separate since the two use different bones, aromatics, and yields.

> 🍱 **Cody's own way in, 2026-09-09 — and why the [Meal Planning Sheet](../meal-planning-sheet.md) lists this as *Pho with Leftover Beef* in its Leftovers group.** *"Sometimes when I sous vide a beef I'll do two or three chuck roasts and reuse it when I make pho."* So in this house the leftover meat is as likely to be sous vide chuck from a deliberately oversized [§1 Cody's Pho](1-codys-pho.md) batch as it is smoked brisket, and the page's brisket is one option rather than the rule. The smoked-bone broth below is the recipe as printed; when the beef is leftover chuck, the broth can just as well be §1's. On his standing rule that leftovers never need the grill, the sheet's line carries no ♨︎.
>
> **📌 2026-09-12 — the sheet line moved, and it is still called *Pho with Leftover Beef*.** Cody retired the sheet's 🍱 Leftovers group that day as his own mistake, and leftovers became a spoken rule instead: **[CLAUDE.md §3f](../../CLAUDE.md)**. **This was one of only three lines whose sole appearance on the sheet was in that group, so it was moved rather than deleted** — it now sits in **🍜 Pasta, Rice & Noodle Bowls** at 🟩(30 min) 🍽️, sorted by minutes like everything else. Same title, same link, same markers. **And when the leftover chuck comes out of the freezer rather than the fridge, it earns a thaw event** — §3f puts a whole chuck roast at **2 days** in the refrigerator on USDA FSIS figures; see [§1 Cody's Pho](1-codys-pho.md), where the batching happens.

**Makes 6 servings · Takes about 20 minutes to prep, about 5 hours to make the broth** *(as printed)*

**Techniques used:** [§T35 Smoke Science](t35-smoke-science--combustion-the-smoke-ring-and-getting-blue-smoke.md) · [§T34 Two-Zone Fire Setup](t34-two-zone-fire-setup.md) · [§T87 Stock — Saving Scraps for the Pot](t87-stock--saving-scraps-for-the-pot.md) · [§T46 Freezing and Reheating Leftovers](t46-freezing-and-reheating-leftovers.md)
...
> **Why Easy, even at seven hours.** Per [CLAUDE.md §3a](../../CLAUDE.md), difficulty is technique risk, not effort — and **[§1 Cody's Pho](1-codys-pho.md) is this cookbook's own reference case** for exactly this call: two days, more moving parts than anything else in the book, rated 🟢 Easy because not one of its steps can fail on you. The same is true here. Smoking bones is unattended, a 4-to-5-hour simmer has a wide doneness window ("reduced by about half"), and everything at the finishing end is a two-minute blanch and a bowl assembly. The hours belong in the Slow cook column, not in the rating.
...
>
> **About the mushrooms.** The source recommends plain cremini or button mushrooms, but if you want to take it up a notch, go for **chanterelles** or something more exotic. See [§T100](t100-mushroom-varieties-buying-storing-and-drying-the-meathead-method.md).
>
...
**7. Brisk it.**
Warm the brisket in the microwave, or wrap it in foil and warm it in a low oven. *(See [§T46 Freezing and Reheating Leftovers](t46-freezing-and-reheating-leftovers.md) if it's coming out of the freezer.)*
...
- 🛒 Leftover smoked beef brisket — 1½ lb *(from [§7.135](7135-championship-brisket-and-burnt-ends.md), [§7.112](7112-texas-beef-brisket.md), or [§6.7](67-texas-style-barbecued-brisket.md))*
- 🛒 Carrots — 4
- 🛒 Onions — 3 medium
- 🛒 Garlic — 4 cloves
...
- **The recipe assumes you already have smoked brisket in the fridge** and doesn't tell you how to make it — that's the point of "leftover." Any of this cookbook's smoked briskets works: the same book's [§7.135 Championship Brisket and Burnt Ends](7135-championship-brisket-and-burnt-ends.md), or [§7.112 Texas Beef Brisket](7112-texas-beef-brisket.md)/[§6.7 Texas-Style Barbecued Brisket](67-texas-style-barbecued-brisket.md) — **and now Cody's own [§6.1 Smoked Brisket](61-smoked-brisket.md) and [§6.10 Sous Vide Brisket](610-sous-vide-brisket-richies-method.md)**, either of which leaves exactly the kind of leftovers this soup is for.
- **The source prints no smoke-wood recommendation** for the bones — noted rather than invented. [§T35 Smoke Science](t35-smoke-science--combustion-the-smoke-ring-and-getting-blue-smoke.md) covers the general wood-buying and blue-smoke rules.
