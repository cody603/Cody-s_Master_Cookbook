<!-- GENERATED from codys-cookbook.md#847-frito-pie — do not edit here; edit the master file and rerun tools/build_planner.py -->
...
- 🛒 Onion — 1
- 🛒 **Louisiana hot sauce** — 1 bottle *(Crystal is what [§8.1](81-chili-mac.md) keeps; see Open Questions for which one he means)*
- 🛒 *Leftover chili — from the fridge. If you're making it fresh, [§8.1](81-chili-mac.md)'s list, without the noodles.*
